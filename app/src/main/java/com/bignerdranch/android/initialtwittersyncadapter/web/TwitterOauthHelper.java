...
public class TwitterOauthHelper {
    ...
    private static final String CONSUMER_KEY = "WdOGRNzWWPkNxrCVJrnOLz5nV";
    private static final String CONSUMER_SECRET = "0JoPO9j0hV3G7VC2XUItxb2KcvRG2qU4A3w5CzbHFYtqKcUDsM";
